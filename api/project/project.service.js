...
module.exports = {
    ...
    createProject: (data) => {
        ...
        return new Promise((resolve, reject) => {
            pool.query(
                `INSERT INTO project
            (project_name, project_code, company_id, project_customer_id, project_start_date, project_end_date, project_segment_number, 
            project_description, project_region_id, project_po_file, project_ehs_file, project_permit, project_design, 
            project_certificate_of_workers, project_manager_id, project_create_date, project_created_by, project_status) 
            VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)`,
                [
                    data.project_name,
                    data.project_code,
    ...
    getProjects:  (company_id) => {
        return new Promise((resolve, reject)=>{
            pool.query(
                `SELECT project.*, CONCAT(Users.user_firstname, ' ', Users.user_lastname) AS project_manager, region.region_name, customer.customer_name FROM project 
...
INNER JOIN Users ON Users.user_id = project.project_manager_id
