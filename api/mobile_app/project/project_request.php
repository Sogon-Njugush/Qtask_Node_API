...
try {
    ...
    // Prepare the SQL query to fetch project assignments
    $sql = "
        SELECT
        ...
        WHERE pa.user_id = ? AND pa.request_status = ''
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            $detailslist = [
                'project_assign_id' => $row['segment_assign_id'],
                'key_plan_id' => '',
        ...
        $response['message'] = "No pending assignments found.";
    }
